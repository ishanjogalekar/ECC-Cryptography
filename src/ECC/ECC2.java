...
public class ECC2{
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("-----------------------------------");
        System.out.println("Elliptic Curve Crypto-system");
        System.out.println("-----------------------------------");
        ...
        System.out.println("\ndecrypted message: "+displayPoint(decryption));

        //-------------------------------------------------

        //baby step giant step approach - https://j...content-available-to-author-only...b.io/assets/elliptic-curves.pdf
